...
//  // PREDIV2 = 5; PLL2MUL = 8; PREDIV1 = 5; PLLMUL = 9; ABP1 = AHB / 2;
//  RCC->CFGR=RCC_CFGR_MCO_NOCLOCK|(0xffffffff&RCC_CFGR_OTGFSPRE)|RCC_CFGR_PLLMULL9|RCC_CFGR_PLLXTPRE_PREDIV1_DIV2|
//          RCC_CFGR_PLLSRC|RCC_CFGR_ADCPRE_DIV8|RCC_CFGR_PPRE2_DIV1|RCC_CFGR_PPRE1_DIV2|
//        RCC_CFGR_HPRE_DIV1|RCC_CFGR_SWS_HSI|RCC_CFGR_SW_HSI;
//
...
//  RCC->CFGR2=(0x0&RCC_CFGR2_I2S3SRC)|(0x0&RCC_CFGR2_I2S2SRC)|RCC_CFGR2_PREDIV1SRC_PLL2|RCC_CFGR2_PLL3MUL10|
//  RCC_CFGR2_PLL2MUL8|RCC_CFGR2_PREDIV2_DIV5|RCC_CFGR2_PREDIV1_DIV5;
//  //ON HSI-for flash write operation
//  RCC->CR|=RCC_CR_HSION ;
//  //ON PLL2
//  RCC->CR|=RCC_CR_PLL2ON;while(!(RCC->CR & RCC_CR_PLL2RDY));
//  //ON PLL
//  RCC->CR|=RCC_CR_PLLON; while(!(RCC->CR & RCC_CR_PLLRDY));
//  //FLASH LATENCY
...
//  //Switch SYSCLK to PLL
  ...
  RCC->APB1ENR|=RCC_APB1ENR_I2C2EN|RCC_APB1ENR_TIM3EN;
...
void portConfig(void){
    ...
    //PB10-SCL2, PB11-SDA2,PB12-PB15 - Display data
